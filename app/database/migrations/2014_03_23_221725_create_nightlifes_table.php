...
class CreateNightlifesTable extends Migration {
	...
	public function up()
	{
		//se crea la tabla de nightlifes
		Schema::create('nightlifes', function(Blueprint $table) {
        {
			$table->increments('id');
	...
	{
		//la tabla nightlifes es eliminada si existe
		Schema::dropIfExists('nightlifes');
	}
