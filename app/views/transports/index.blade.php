...
@section('content')
	...
	<?php
		$id = Transport::where('id_user', '=', Auth::user()->id)->pluck('id');
		$name = Transport::where('id_user', '=', Auth::user()->id)->pluck('name'); 
		$address = Transport::where('id_user', '=', Auth::user()->id)->pluck('address');
		$overview = Transport::where('id_user', '=', Auth::user()->id)->pluck('overview');
	?>
